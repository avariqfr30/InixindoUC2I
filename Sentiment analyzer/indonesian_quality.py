"""Deterministic, non-mutating Indonesian feedback-report checks."""
...
class IndonesianQualityGate:
    DEFAULT_ALLOWLIST = {
        "feedback", "dashboard", "sentiment", "touchpoint", "journey", "insight",
        "score", "scoring", "baseline", "benchmark", "owner", "timeline", "osint",
        "markdown", "nps", "csat", "trainer", "training", "fasilitator", "responden",
        "preskriptif", "prediktif", "diagnostik", "deskriptif", "intervensi",
    }
