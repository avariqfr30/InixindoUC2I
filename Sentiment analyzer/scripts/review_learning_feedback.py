...
elif args.command == "approve": store.approve_reason(args.reason_code, approved_by=args.reviewer); print("Panduan feedback diaktifkan untuk UC2.")
else: store.retire_reason(args.reason_code); print("Panduan feedback dinonaktifkan untuk UC2.")
